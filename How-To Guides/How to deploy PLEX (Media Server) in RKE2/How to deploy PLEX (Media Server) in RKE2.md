...
&emsp; [1] Install software dependencies. <br>
&emsp; [2] Create a username/password security file for our SMB share. <br>
&emsp; [3] Create a mount directories for our SMB share(s). <br>
&emsp; [4] Mount SMB share(s). <br>
&emsp; [5] Deploy PLEX <br>

&emsp; [#] Helpful Commands/Scenarios <br>

***

### 📋 Prerequisites and Assumptions
- RKE2 is deployed in a similar architecture to [How to deploy RKE2 (Rancher Kubernetes Engine 2)](../How%20to%20deploy%20RKE2%20(Rancher%20Kubernetes%20Engine%202)/How%20to%20deploy%20RKE2%20(Rancher%20Kubernetes%20Engine%202).md). <br>
     - DNS Record >> Virtual (floating) IP >> RKE2 Ingress-NGINX >> App (PLEX). <br>
